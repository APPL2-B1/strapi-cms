...
$lang_navigation_education = "教育";
$lang_navigation_contact = "連絡先";
$lang_navigation_partnership = "パートナーシップ";
$lang_navigation_facility = "施設";
$lang_navigation_news = "ニュース";
$lang_navigation_information_documentation = "ドキュメント";
$lang_navigation_information_documentation_burger = "ドキュメント";
$lang_navigation_major_profile = "学部プロファイル";
$lang_navigation_studi_programs_profile = "学科プロファイル";
$lang_navigation_staff_profile_list = "大学職員プロファイルリスト";
$lang_navigation_curriculum = "カリキュラム";
$lang_navigation_agenda = "アジェンダ";
$lang_navigation_achievement_list = "研究成果";
$lang_navigation_gallery = "ギャラリー";
$lang_navigation_tracer_study = "研究欄";
$lang_navigation_japanese = "日本語";
$lang_navigation_english = "英語";
$lang_navigation_indonesian = "インドネシア語";
$lang_navigation_search = "検索";
$lang_navigation_go_top = "トップページ";
$lang_navigation_toggle_template = "テンプレートに切り替えます";
...
次のように非常に多様です。";
$lang_major_profile_work_prospect_footer = "上記の専門分野に加えて、
